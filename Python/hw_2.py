...
print('result subtr =', result_subtr)
...
print('result multi =', result_multi)
...
import math
result_m = math.pow(item_1, item_2)

# 12. Вывести result_m_exp в консоль.
print('result m =', result_m)
...
print('result s root =', result_s_root)
...
print('result m =', result_m_s_root)
...
result_mp_root = math.pow(item_2, 0.5)

# 18. Вывести result_mp_s_root в консоль.
print('result mp root', result_mp_root)
...
print('result division =', result_division)
...
print ('result m ceil =', result_m_ceil)
...
print('result bo d loss =', result_no_division_loss)
...
print('result div loss =', result_division_loss)
...
print('b item selulr str =', b_item_result_subtr)
...
print('result multy =', b_item_result_multi)
